...
import friskmod.powers.CountdownRuins;
...
public class Ruins extends AbstractEasyCard {
    public static final String ID = makeID(Ruins.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    private static final int WAIT_TIMER = 7;
