...
public class Duel extends AbstractEasyCard {
    public static final String ID = makeID(Duel.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
        ...
        Wiz.atb(new AbstractGameAction() {
            ...
            public void update() {
                ...
                tmp.group = (ArrayList<AbstractCard>) Wiz.p().drawPile.group.stream()
                        .filter(c -> c.hasTag(CardTags.STRIKE))
