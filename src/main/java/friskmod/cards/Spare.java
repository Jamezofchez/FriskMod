...
public class Spare extends AbstractEasyCard {
    public static final String ID = makeID(Spare.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    private static final int FLEE_AFTER_CARD_AMOUNT = 12;
