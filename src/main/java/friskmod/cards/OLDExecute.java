...
//
//public class OLDExecute extends AbstractEasyCard {
//    public static final String ID = makeID(OLDExecute.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
