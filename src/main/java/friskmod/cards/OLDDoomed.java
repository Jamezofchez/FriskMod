...
//
//public class OLDDoomed extends AbstractEasyCard {
//    public static final String ID = makeID(OLDDoomed.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
