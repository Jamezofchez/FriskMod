...
//import static friskmod.patches.CardXPFields.setPreviewLock;
//
//public class LeftScale extends AbstractEasyCard {
//    public static final String ID = makeID(LeftScale.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
...
//    private static final int LOSE_HP = 7;
...
//            CardXPFields.setPreview(this, 0);
//            setPreviewLock(this, true);
//            dmg(m, AbstractGameAction.AttackEffect.BLUNT_HEAVY);
//            addToBot(Wiz.actionify(() -> {
//                setPreviewLock(this, false);
//            }));
...
//        CardXPFields.setPreview(this, getPreview());
//        super.applyPowers();
...
//        return Math.max(0, magicNumber - TempHPField.tempHp.get(AbstractDungeon.player));
//    }
//
