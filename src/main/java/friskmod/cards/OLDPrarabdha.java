...
//
//public class OLDPrarabdha extends AbstractEasyCard {
//    public static final String ID = makeID(OLDPrarabdha.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
