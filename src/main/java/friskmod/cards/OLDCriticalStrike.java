...
public class CriticalStrike extends AbstractCriticalCard {
    public static final String ID = makeID(CriticalStrike.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
