...
//
//public class OLDCriticalStrike extends AbstractCriticalCard {
//    public static final String ID = makeID(OLDCriticalStrike.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
