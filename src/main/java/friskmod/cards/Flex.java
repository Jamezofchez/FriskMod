...
public class Flex extends AbstractEasyCard {
    public static final String ID = makeID(Flex.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    private static final int GIVEN_LV = 4;
