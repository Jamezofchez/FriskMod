...
public class BadMemory extends BaseCard{
    ...
    private static final CardStats info = new CardStats(
            Frisk.Meta.CARD_COLOR, //The card color. If you're making your own character, it'll look something like this. Otherwise, it'll be CardColor.RED or similar for a basegame character color.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new MakeTempCardInHandAction(new FreakBullet(), magicNumber));
