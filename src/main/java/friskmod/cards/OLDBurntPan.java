...
//
//public class OLDBurntPan extends AbstractEasyCard {
//    public static final String ID = makeID(OLDBurntPan.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
