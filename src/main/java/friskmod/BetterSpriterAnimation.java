...
public class BetterSpriterAnimation extends AbstractAnimation {
  ...
  public BetterSpriterAnimation(String filepath) {
    ...
    this.drawer = new BetterLibGdxDrawer((Loader<Sprite>)this.loader, this.renderer);
...
/* Location:              C:\Program Files (x86)\Steam\steamapps\workshop\content\646570\2396661789\Ruina.jar!\ruina\BetterSpriterAnimation.class
