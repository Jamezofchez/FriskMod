...
import static friskmod.FriskMod.characterPath;
import static friskmod.FriskMod.makeID;

public class Frisk extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Frisk"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new Frisk(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
