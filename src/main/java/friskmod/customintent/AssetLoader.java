...
public class AssetLoader {
    ...
    public static Texture loadImage(String fileName) {
        ...
        return (Texture) assets.get(fileName, Texture.class);
    }
    ...
    public static TextureAtlas loadAtlas(String fileName) {
        ...
        return (TextureAtlas) assets.get(fileName, TextureAtlas.class);
    }
    ...
    public static boolean isLoading(String fileName) {
        for (Object assetDesc : (Array) ReflectionHacks.getPrivate(assets, AssetManager.class, "loadQueue")) {
            AssetDescriptor assetDescriptor = (AssetDescriptor) assetDesc;
            if (assetDescriptor.fileName.equals(fileName)) {
                return true;
            }
        }
